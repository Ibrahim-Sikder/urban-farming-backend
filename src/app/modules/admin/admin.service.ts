...
export class AdminService {
    static async getDashboardStats(filters?: DashboardFilters): Promise<DashboardStatsResponse> {
        try {
            ...
            const [
                ...
                pendingVendors, pendingCertifications, totalRentalSpaces,
                totalRevenueResult, recentOrders, recentUsers
            ] = await Promise.all([
    ...
    static async getAllUsers(queryParams: UserQueryParams = {}): Promise<PaginatedResponse<any>> {
        try {
            ...
            const queryBuilder = new PrismaQueryBuilder('User', {
            ...
            queryBuilder.addCustomCondition(Prisma.sql`"deletedAt" IS NULL`);
            ...
            const response: PaginatedResponse<any> = { data: transformedUsers, meta: result.meta };
    ...
    static async getAllVendors(queryParams: VendorQueryParams = {}): Promise<PaginatedResponse<VendorListResponse>> {
        try {
            ...
            const queryBuilder = new PrismaQueryBuilder('VendorProfile', {
                page: queryParams.page, limit: queryParams.limit,
                sortBy: queryParams.sortBy, sortOrder: queryParams.sortOrder,
                searchTerm: queryParams.searchTerm,
            ...
            const response: PaginatedResponse<VendorListResponse> = { data: transformedVendors, meta: result.meta };
            await RedisCacheService.setFast(cacheKey, response, 120);
            return response;
        } catch (error) {
    ...
    static async verifyVendor(vendorId: number, status: CertificationStatus, rejectionReason?: string): Promise<any> {
        try {
            ...
            await Promise.all([
                ...
                RedisCacheService.delPattern('admin:dashboard:*'),
                RedisCacheService.del(`vendor:profile:${vendor.userId}`)
            ]);
    ...
    static async getAllCertifications(queryParams: CertificationQueryParams = {}): Promise<PaginatedResponse<CertificationListResponse>> {
        try {
            ...
            const queryBuilder = new PrismaQueryBuilder('SustainabilityCert', {
                page: queryParams.page, limit: queryParams.limit,
                sortBy: queryParams.sortBy, sortOrder: queryParams.sortOrder,
            ...
            const response: PaginatedResponse<CertificationListResponse> = { data: transformedCerts, meta: result.meta };
            await RedisCacheService.setFast(cacheKey, response, 120);
            return response;
        } catch (error) {
    ...
    static async verifyCertification(certId: number, status: CertificationStatus, verificationNotes?: string): Promise<any> {
        try {
            ...
            const updatedCert = await prisma.sustainabilityCert.findUnique({
                where: { id: certId },
    ...
    static async getAllRentalSpaces(queryParams: PaginationParams = {}): Promise<PaginatedResponse<any>> {
        try {
            ...
            const queryBuilder = new PrismaQueryBuilder('RentalSpace', {
                page: queryParams.page, limit: queryParams.limit,
                sortBy: queryParams.sortBy, sortOrder: queryParams.sortOrder,
                searchTerm: queryParams.searchTerm
            });
            ...
            const response: PaginatedResponse<any> = { data: transformedSpaces, meta: result.meta };
            await RedisCacheService.setFast(cacheKey, response, 120);
            return response;
        } catch (error) {
    ...
    static async getAllOrders(queryParams: OrderQueryParams = {}): Promise<PaginatedResponse<any>> {
        try {
            ...
            const queryBuilder = new PrismaQueryBuilder('Order', {
                page: queryParams.page, limit: queryParams.limit,
                sortBy: queryParams.sortBy, sortOrder: queryParams.sortOrder,
            ...
            if (queryParams.minAmount !== undefined) {
                queryBuilder.addCustomCondition(Prisma.sql`"totalPrice" >= ${queryParams.minAmount}`);
            }
            if (queryParams.maxAmount !== undefined) {
                queryBuilder.addCustomCondition(Prisma.sql`"totalPrice" <= ${queryParams.maxAmount}`);
            }
            ...
            const response: PaginatedResponse<any> = { data: transformedOrders, meta: result.meta };
            await RedisCacheService.setFast(cacheKey, response, 120);
            return response;
        } catch (error) {
