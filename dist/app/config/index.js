...
if (!exports.config.jwt.secret) {
  ...
  console.error(
    "Example: JWT_SECRET=your-super-secret-key-min-32-characters\n",
  );
...
console.log(
  `🔐 JWT Secret: ${exports.config.jwt.secret ? "✓ Set" : "✗ Missing"}`,
);
console.log(
  `🗄️  Database URL: ${exports.config.databaseUrl ? "✓ Configured" : "✗ Missing"}`,
);
